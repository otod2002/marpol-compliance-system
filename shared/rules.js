...
const EXPIRY_HORIZON_DAYS = 30;   // configurable forward horizon (FR-24)
const VARIANCE_TOLERANCE_PCT = 10; // configurable tolerance (FR-42)
 ...
 */
function isApplicable(rule, vessel) {
 ...
 */
function evaluateCertificate(certificate, inspectionDate, horizonDays = EXPIRY_HORIZON_DAYS) {
 ...
 */
function scoreInspection(items, responses, vessel, opts = {}) {
 ...
 */
function reconcileCustody(declaration, note, events, tolerancePct = VARIANCE_TOLERANCE_PCT) {
